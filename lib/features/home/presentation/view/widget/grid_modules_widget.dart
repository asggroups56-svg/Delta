              ...
              children: [
                Container(
                  ...
                  child: ShaderMask(
                    ...
                    child: Icon(mod['icon'] as IconData, size: 26.r, color: Colors.white),
                  ),
                ),
                Gap(6.h),
                Text(
                  ...
                  style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w500, color: AppColor.whiteColor(context).withValues(alpha: 0.85)),
                ),
              ],
            ),
          ),
